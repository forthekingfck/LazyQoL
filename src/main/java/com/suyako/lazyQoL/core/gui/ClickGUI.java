...
public class ClickGUI extends GuiScreen {
    ...
    public void initGui(){
        ...
        BackButton = new GuiClickGUIButton(0,10,this.height - 25,widthBound - 10,18,"Back",new ResourceLocation(LazyQoL.MODID,"clickgui/back.png"));
    ...
    public void drawScreen(int x, int y, float delta)
    {
        ...
        Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("clickgui/GuiIcon.png"));
