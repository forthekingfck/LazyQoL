...
public class GuiScrollButton extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            if(isCoveredByMouse) {
                mc.getTextureManager().bindTexture(new ResourceLocation("clickgui/" + IconLocation2 + ".png"));
            } else {
                mc.getTextureManager().bindTexture(new ResourceLocation("clickgui/" + IconLocation1 + ".png"));
            }
