...
public class GuiTableButton extends GuiClickGUIButton{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        if (this.visible) {
            ...
            if(type) {
                Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation( "clickgui/function.png"));
            } else {
                Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation( "clickgui/menu.png"));
            }
