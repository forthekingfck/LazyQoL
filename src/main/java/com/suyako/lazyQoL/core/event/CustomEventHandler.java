package com.suyako.lazyQoL.core.event;
...
public class CustomEventHandler {
    ...
    public static class FunctionEnableEvent extends Event {
        ...
        public FunctionEnableEvent(LazyQoLFunction function){
    ...
    public static class FunctionDisabledEvent extends Event {
        public LazyQoLFunction function;
        public FunctionDisabledEvent(LazyQoLFunction function){
            this.function = function;
        }
    }
    ...
    public static class FunctionSwitchEvent extends Event {
        ...
        public FunctionSwitchEvent(LazyQoLFunction function, boolean status){
            this.function = function;
            this.status = status;
        }
    }
    ...
    //trigger on a custom message received from lazyQoL channel
