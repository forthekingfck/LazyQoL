package com.suyako.lazyQoL.utils;
...
import com.suyako.lazyQoL.core.type.Rotation;
...
public class Utils {
    ...
    public static void print(String message) {
        if (Minecraft.getMinecraft().theWorld != null) {
            Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.AQUA + "[" + EnumChatFormatting.WHITE + "LazyQoL" + EnumChatFormatting.AQUA + "]" + EnumChatFormatting.WHITE + " -> " + message + "."));
        }
    }

    public void devLog(String message) {
        if (Minecraft.getMinecraft().theWorld != null) {
            Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.DARK_GREEN + "[" + EnumChatFormatting.GOLD + "LazyQoL" + EnumChatFormatting.DARK_RED + "Dev" + EnumChatFormatting.DARK_GREEN + "]" + EnumChatFormatting.YELLOW + message + "."));
        }
    }
    ...
    static String MarketingAccountTemplate = "okay...";
