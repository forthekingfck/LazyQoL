...
import com.suyako.lazyQoL.core.via.loader.BackwardsLoader;
import com.suyako.lazyQoL.core.via.loader.RewindLoader;
import com.suyako.lazyQoL.core.via.platform.Injector;
import com.suyako.lazyQoL.core.via.platform.Platform;
import com.suyako.lazyQoL.core.via.platform.ProviderLoader;
import com.suyako.lazyQoL.utils.JLoggerToLog4j;
...
public class Via {
    ...
    private final Logger jLogger = new JLoggerToLog4j(LogManager.getLogger("LazyQoL"));
    ...
    public void start() {
        ThreadFactory factory = new ThreadFactoryBuilder().setDaemon(true).setNameFormat("lazyQoL_via").build();
        ...
        this.file = new File("LazyQoL/via");
        this.file.mkdir();
