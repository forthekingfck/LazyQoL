...
import com.suyako.lazyQoL.common.mixins.S08PacketPlayerPosLookAccessor;
...
import com.suyako.lazyQoL.utils.timer.SystemTimer;
        ...
        if(Minecraft.getMinecraft().thePlayer != null && Minecraft.getMinecraft().theWorld != null) {
            if (isEnable) {
                ...
                if (banWarning && packet instanceof S02PacketChat && ((S02PacketChat) packet).getChatComponent().getUnformattedText().toLowerCase().contains(("Cages opened!".toLowerCase()))) {
                    Utils.print("[Disabler] please stop use, watchdog stare at you");
                    inCage = false;
                }
