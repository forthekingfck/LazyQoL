...
import com.suyako.lazyQoL.common.mixins.MinecraftAccessor;
    ...
    public void onEnable(CustomEventHandler.FunctionEnableEvent event) {
        if (event.function.getName().equals("ForagingBot")) {
            if (!init()) {
                ...
                Utils.print("cannot find nearby dirt");
            }
        }
    }
                ...
                if (event.phase == TickEvent.Phase.START) {
                    if(stage != null){
                        if (stage == EnumStage.EMPTY) {
                            if(!LazyQoL.NoSaplingBound){
                                LazyQoL.NoSaplingBound = true;
                                LazyQoL.NoTreeBound = true;
                            }
                            if(!LazyQoL.NoTreeBound){
                                LazyQoL.NoTreeBound = true;
                            }
                            checkSwitch("sapling");
                            ...
                            if(LazyQoL.NoSaplingBound){
                                LazyQoL.NoSaplingBound = false;
                                LazyQoL.NoTreeBound = false;
                            }
                            if(LazyQoL.NoTreeBound){
                                LazyQoL.NoTreeBound = false;
                            }
